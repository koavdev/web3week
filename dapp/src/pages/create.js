...
export default function Create(){
    ...
    function btnSaveClick() {
        setMessage("Saving... wait a minute");
        addCampaign(campaign)
            .then(tx => getLastCampaignId())
            .then(id => setMessage(`Campaign saved with ID <b>${id}</b>. Share with your friends!`))
            .catch(err => {
                console.error(err);
    ...
    return (        
        <>
            <Head>
                <title>Donate Crypto | Create a New Campaign</title>
                <meta charSet='utf-8' />
            ...
            <div className="container">
                ...
                <div className="col-6">
                    ...
                    <div className="form-floating mb-3">
                        <textarea type="text" id="description" className="form-control" value={campaign.description} onChange={onInputChange} />
